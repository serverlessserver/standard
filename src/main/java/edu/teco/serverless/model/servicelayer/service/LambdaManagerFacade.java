...
public interface LambdaManagerFacade {
     ...
     */
    public String addLambda(Lambda lambda) throws LambdaDuplicatedNameException, RuntimeConnectException, IOException, LanguageNotSupportedException, IllegalAccessException, InstantiationException, ClassNotFoundException, TimeExceededException;
     ...
     */
    public String updateLambda(String name, Lambda lambda) throws LambdaNotFoundException, RuntimeConnectException, LanguageNotSupportedException, TimeExceededException, IllegalAccessException, InstantiationException, ClassNotFoundException, IOException;
     ...
     */
    public Lambda getLambda(String name) throws LambdaNotFoundException, RuntimeConnectException, IOException, IllegalAccessException, InstantiationException, ClassNotFoundException, TimeExceededException;
     ...
     */
    public String executeLambda(String name, ExecuteConfig executeConfig) throws LambdaNotFoundException, RuntimeConnectException, TimeExceededException, IllegalAccessException, InstantiationException, ClassNotFoundException, IOException;
     ...
     */
    public void deleteLambda(String name) throws LambdaNotFoundException, RuntimeConnectException, TimeExceededException, IllegalAccessException, InstantiationException, ClassNotFoundException, IOException;
