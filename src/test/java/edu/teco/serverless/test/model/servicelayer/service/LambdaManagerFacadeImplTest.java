...
public class LambdaManagerFacadeImplTest {
     ...
     */
    @Test
    public void addValidLambda() throws RuntimeConnectException, IOException, LanguageNotSupportedException, TimeExceededException, IllegalAccessException, ClassNotFoundException, InstantiationException {
    ...
    public void addExistedLambda() throws LambdaDuplicatedNameException, RuntimeConnectException, IOException, LanguageNotSupportedException, ClassNotFoundException, TimeExceededException, InstantiationException, IllegalAccessException {
     ...
     */
    @Test
    public void executeValidLambda() throws RuntimeConnectException, IOException, TimeExceededException, LanguageNotSupportedException, ClassNotFoundException, InstantiationException, IllegalAccessException {
        //lambdaManager.addLambda(lambda);
    ...
    public void executeInvalidLambda() throws LambdaNotFoundException, RuntimeConnectException, TimeExceededException, ClassNotFoundException, IOException, InstantiationException, IllegalAccessException {
     ...
     */
    @Test
    public void updateLambda() throws RuntimeConnectException, LanguageNotSupportedException, TimeExceededException, IOException, ClassNotFoundException, InstantiationException, IllegalAccessException {
     ...
     */
    @Test
    public void getLambda() throws RuntimeConnectException, IOException, LanguageNotSupportedException, ClassNotFoundException, TimeExceededException, InstantiationException, IllegalAccessException {
     ...
     */
    @Test(expected = LambdaNotFoundException.class)
    public void deleteLambda() throws LambdaNotFoundException, RuntimeConnectException, IOException, LanguageNotSupportedException, TimeExceededException, ClassNotFoundException, InstantiationException, IllegalAccessException {
      //  lambdaManager.addLambda(lambda);
