...
public class ExceptionsHandler {
    ...
    public ResponseEntity handleAuthorizationException(AuthorizationException ex) {
        ...
        return ResponseEntity.status(HttpStatus.UNAUTHORIZED).body(new RestErrorInfo("Error, Authorization failed." + ex.getLocalizedMessage()));
    }
    ...
    public ResponseEntity handleExceptions(Exception ex) {
        ...
        return ResponseEntity.status(HttpStatus.CONFLICT).body(new RestErrorInfo("Internal error."));
    }
